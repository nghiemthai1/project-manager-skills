...
All 42 packages were reviewed for chart fit. Graphical guidance applies when useful or requested; text-first jobs are not forced into charts. Package-local references remain usable when copied independently.
