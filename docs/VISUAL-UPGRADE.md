...
- All 44 packages have a recorded [visual route](VISUAL-COVERAGE.md). Thirty-three additional packages have job-specific visual contracts. Nine remain conversation/text-first by default; charts are not manufactured where they add no decision value.
