...
- Three additional rendered software companions cover benefits, WBS and stakeholder mapping. Their source tables, assumptions and editable JSON accompany the SVGs. Dependency Map, Resource Capacity Plan, Project Budget, Release Readiness and Risk Workshop have moved from this static-companion set to dedicated software/migration renderers.
