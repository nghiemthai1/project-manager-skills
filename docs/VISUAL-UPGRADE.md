...
- All 45 packages have a recorded [visual route](VISUAL-COVERAGE.md). Thirty-three additional packages have job-specific visual contracts. Ten remain conversation/text-first by default; charts are not manufactured where they add no decision value.
