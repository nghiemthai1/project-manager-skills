...
- Four additional rendered software companions cover benefits, WBS, stakeholder mapping and risk evidence. Their source tables, assumptions and editable JSON accompany the SVGs. Dependency Map, Resource Capacity Plan, Project Budget and Release Readiness have moved from this static-companion set to dedicated software/migration renderers.
