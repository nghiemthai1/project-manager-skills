# Logic network plus milestone view
...
Capture: **activity ID; typed predecessors; lag/calendar; duration unit; date constraints; computed float/critical source; milestone authority**.
...
Use the [offline renderer](renderer.md) when the request needs the full decision workspace. Its browser-local editor validates task evidence and logic, recalculates offsets, float and criticality, preserves the embedded source exports, and labels editable draft exports separately.
