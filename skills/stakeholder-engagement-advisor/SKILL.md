...
**Example invocation:** `Plan engagement: our Business Sponsor publicly supports the replatform but keeps escalating exceptions — QBR in 2 weeks.`
...
> 3. **End user or community representative** — the person or group who will live with the project's outcomes daily; may have limited org power but high stakes in the result
...
> 2. **High power, low impact** — they control resources or approval but aren't significantly affected day-to-day (e.g., a CFO approving budget for a service they'll never use)
> 3. **Low power, high impact** — they're directly affected by the project's outcome but have limited org authority to shape it (e.g., frontline users, support agents, end communities)
...
> 2. **Pre-milestone alignment** — project baseline review, launch gate, OKR commitment, or exec briefing coming up; you need this stakeholder in a good place beforehand
...
> *User:* "Executive Sponsor — she's the exec sponsor. We've had two brief introductions at all-hands. She's publicly supportive but we've never had a real conversation about what she actually thinks about the approach."
>
> *Advisor:* "Which profile fits best: 1-5?" [see Question 1]
> *User:* "1 — Executive sponsor."
>
> *Advisor:* "Power and impact?" [see Question 2]
> *User:* "1 — High power, high impact. Her org uses the delivered service and she controls the Q3 budget commitment."
>
...
> 3. **Informal check-in** — A brief hallway or coffee conversation, no slides. Lower risk if her support is likely solid; insufficient if evidence suggests a material unresolved objection.
>
...
> 1. **Structured research recruitment** — Propose a small representative set of agents for workflow interviews, with sample size and timing agreed to fit the population and consequences. This gives you validated insight before requirements are locked and signals that their perspective shapes the delivered service.
...
> *Next action:* [You] coordinate with support manager by [date] to agree representative workflow interviews, with the message: 'We're redesigning intake and need the team's perspective to get it right.'"
...
**Ending without a named next action.** An engagement plan without owner, action, medium, and deadline is an intention. Intentions don't move relationships forward. The next action needs an accepted owner and a feasible date; otherwise show the proposed assignment and the unresolved commitment.

**Using the same medium for all stakeholders.** An executive who's already in back-to-back meetings doesn't need another meeting — they need a well-written pre-read. A frontline user who has never been consulted may need an accessible workflow discussion rather than a broadcast email; choose a channel they can actually use and honor their preference. Match the medium to the relationship and context.
...
- [stakeholder-map](../stakeholder-map/SKILL.md) — prerequisite: prioritize stakeholders and identify Q1 voices before engagement planning
- [acceptance-and-traceability](../acceptance-and-traceability/SKILL.md) — involve user representatives in defining and reviewing acceptance evidence
...
Adapted closely from Dean Peters's [stakeholder-engagement-advisor](https://github.com/deanpeters/Product-Manager-Skills/blob/1b5a524ebb95e9497fa3f25002d8b8ec528d4444/skills/stakeholder-engagement-advisor/SKILL.md). See [source and change notes](SOURCE.md) and [CC BY-NC-SA 4.0](LICENSE.md).
