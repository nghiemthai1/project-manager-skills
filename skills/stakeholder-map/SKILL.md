...
**Impact × Power** answers: who bears the consequences of this project's outcomes, and how much organizational power do they actually hold? It surfaces the stakeholders who matter most to get right but are most likely to be underrepresented — high impact, low power.

Running only the first grid optimizes for managing relationships with the powerful. Running only the second produces an equity analysis without an engagement plan. The insight lives in comparing them: a stakeholder who appears in "keep informed" on the first grid and "high impact, low power" on the second may be someone you have under-engaged despite material consequences for them; verify the exposure rather than assume it. That's a delivery and adoption risk.
...
**Elevating Q1 Voices** — High-impact, low-power stakeholders (Q1) are the people most likely to experience the delivered service's failure modes and least likely to appear in your normal feedback loops. Deliberately increasing their role in scope and transition decisions — through research recruitment, usability testing, and requirements review — is not just equitable; it reduces the delivery and adoption risk of delivering an unusable service.

**Quadrant Migration** — The deliberate strategy of moving a stakeholder from their current quadrant to a desired one through targeted actions. A low-interest decision maker who needs to become actively engaged requires different actions from an already engaged sponsor; skepticism alone does not establish a quadrant. Making migration explicit turns the map from a snapshot into a plan.

**Impact vs. Power** — These are not the same dimension. A frontline support agent has high impact (their daily workflow changes completely) but low power (no seat at the project decision table). A VP of Finance has high power (budget approval) but low impact (the delivered change doesn't affect how they work). Conflating the two is the most common mapping error.
...
- Who appears in "keep informed" on Grid 1 and Q1 (high impact, low power) on Grid 2? These are stakeholders you're under-engaging relative to how much the delivered change affects them.
- Who appears in "manage closely" on Grid 1 and Q4 on Grid 2? These are powerful stakeholders with little stake in the outcome — watch for over-investment.
...
- Q1 → greater influence: Recruit affected people into advisory processes, workflow trials, and requirements review. Give them a named role. Participation alone does not create formal approval power; only change the power placement if influence or delegated authority actually changes.
...
**Treating placement as permanent.** Org changes, budget cycles, and stakeholder rotations shift people between quadrants. Build in a re-run cadence at project governance review cycles or after significant org events.
...
- [acceptance-and-traceability](../acceptance-and-traceability/SKILL.md) — involve affected representatives in acceptance criteria and evidence review
...
Adapted closely from Dean Peters's [stakeholder-mapping](https://github.com/deanpeters/Product-Manager-Skills/blob/1b5a524ebb95e9497fa3f25002d8b8ec528d4444/skills/stakeholder-mapping/SKILL.md). See [source and change notes](SOURCE.md) and [CC BY-NC-SA 4.0](LICENSE.md).
