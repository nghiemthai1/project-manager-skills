# Independent gate evidence matrix
...
Capture: **gate/criterion ID; version; evidence; applicability; accepting authority; exception; decision state**.

Use a matrix with explicit pass/fail/missing/unknown and evidence links. A failed mandatory condition remains visible. Separate technical readiness, authorization, immediate coverage and later service transfer.

## Interpretation

Display the evidence available at the readiness cutoff and the resulting recommendation. Later acceptance must not fill an earlier missing-evidence row.
...
Use the [offline renderer](renderer.md) for the full decision workspace. Its browser-local editor validates gate classification, results, acceptance, exception authority and evidence dates; recalculates blockers; preserves embedded source exports; and labels draft exports separately.
