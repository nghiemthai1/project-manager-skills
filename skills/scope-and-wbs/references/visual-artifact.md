...
Capture: **WBS ID; parent; scope version; included/excluded boundary; completion evidence; proposed role**.

Use a readable tree or indented table with links to the dictionary. Arrows mean decomposition, never sequence or authority. Do not use rectangle area as effort unless estimates exist. Preserve excluded work beside the tree.

## Interpretation

Show deliverable boundaries, including recovery and transition. A technical component tree can omit acceptance work or double-count shared guidance.
...
Use the [offline renderer](renderer.md) for the full scope-control workspace. Its browser-local editor validates parent changes, hierarchy cycles, package fields and requirement links; recalculates coverage, overlap, maturity, ownership and proposed-change findings; preserves embedded source exports; and labels draft exports separately.
