...
Capture: **risk ID; cause/event/effect; scale definitions; assessment confidence; existing control evidence; residual assessment; response**.

A probability-impact grid is optional, and only meaningful with explicit ordinal scales. Expose unknown probability and hard acceptance conditions. Link each plotted risk to response, trigger and evidence; score is not money or probability.

## Interpretation

Place unassessed risks in an explicit unknown lane. Mandatory evidence requirements remain visible even when probability is unknown.
...
Use the [offline renderer](renderer.md) for the full workshop workspace. Its browser-local editor validates ratings, response and acceptance boundaries, recalculates declared priority, preserves unknown ratings and embedded source exports, and labels draft exports separately.
