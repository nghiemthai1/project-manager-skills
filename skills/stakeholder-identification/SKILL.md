...
Most PM stakeholder lists are written from memory in five minutes. They reliably capture executives, delivery peers, and the most vocal users. They reliably miss the marginalized user groups who bear the project's consequences without having the organizational power to shape its decisions. This skill forces a slower, more structured brainstorm that builds the foundation for every engagement decision that follows.

Use this before stakeholder-map (which prioritizes) and before stakeholder-engagement-advisor (which plans per-stakeholder outreach). Identification comes first — you cannot prioritize people you haven't named.

## Input

**Works best with:** The initiative, project, or decision you're mapping stakeholders for.
...
**Identification vs. Prioritization** — The discipline of separating who exists from who matters most. The goal of this skill is a complete list, not a prioritized one. Collapsing these two steps causes teams to prematurely cut stakeholders they haven't yet understood. Prioritization happens in stakeholder-map.

## Application

Supplied context counts as answers already given. Mark provisional categories and R/P/D authority explicitly; do not infer approval power from seniority or ally status. R/P/D is not RACI: its R means Resources, not Responsible. Roles and groups are valid early entries when named representatives are still unknown.
...
- Who experiences a significant difference or consequence from this change — financially, professionally, or in their daily experience?
- Who bears the project's costs or risks without having the power to shape its design?
...
Add anyone the equity lens surfaces. These stakeholders are likely to end up in Q1 of your stakeholder-map (high impact, low power) — the voices most important to elevate.
...
**Treating the first brainstorm as the final list.** The initial pass can miss less visible stakeholders; no universal completeness percentage is assumed. The categorization and equity steps exist to close that gap — skipping them defeats the exercise.

**Listing roles or org units instead of people.** A broad group such as "Engineering" may be a useful discovery entry, but identify the relevant lead or validated representative before relying on it for a specific decision. Vague category names prevent you from booking the conversation you actually need.

**Conflating identification with prioritization.** Cutting stakeholders during the brainstorm phase, before you've understood their actual influence or impact, is how high-impact, low-power voices get silently dropped. Complete the list first. Prioritize in stakeholder-map.
...
- [stakeholder-map](../stakeholder-map/SKILL.md) — next step: prioritize the identified stakeholders using Power × Interest and Impact × Power grids
...
- [acceptance-and-traceability](../acceptance-and-traceability/SKILL.md) — involve affected representatives in observable acceptance criteria
- [communication-plan](../communication-plan/SKILL.md) — turn validated audience needs into communication and response arrangements
...
Closely adapted from Dean Peters's [stakeholder-identification](https://github.com/deanpeters/Product-Manager-Skills/blob/1b5a524ebb95e9497fa3f25002d8b8ec528d4444/skills/stakeholder-identification/SKILL.md). See [source/change notes](SOURCE.md) and [CC BY-NC-SA 4.0](LICENSE.md).
