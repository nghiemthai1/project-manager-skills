# Exception board with optional risk grid
...
Capture: **record ID/type; cause/event/effect; probability/impact evidence; owner; trigger; action; status/date**.
...
Use the [offline renderer](renderer.md) for the full RAID control workspace. Its browser-local editor validates type-specific lifecycle, rating, acceptance, link and date rules; recalculates attention, unknown and overdue states; preserves linked record history and embedded source exports; and labels draft exports separately.
